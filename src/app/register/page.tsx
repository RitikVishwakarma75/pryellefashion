...
import { Sparkles, Eye, EyeOff, ArrowRight, Lock, Mail, User, Phone, ShieldCheck } from 'lucide-react';
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <span className="block caps-subtitle text-[10px] tracking-[0.3em] text-[#C5A059] mb-1">
            HAUTE HAIRWEAR MEMBERSHIP
          </span>
          <h1 className="editorial-serif text-3xl sm:text-4xl text-white font-normal mb-2">
            Create an Account
          </h1>
          <p className="text-stone-400 text-xs sm:text-sm">
            Join the PRAYELE circle to enjoy priority drops, saved addresses, and express checkout.
          </p>
        </div>
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.6)]">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className="w-full pl-11 pr-10 py-3 rounded-xl bg-white/[0.05] border border-white/10 text-white text-sm placeholder:text-stone-600 focus:outline-none focus:border-[#C5A059] transition-all"
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-xs text-stone-400">
              Already have a PRAYELE account?{' '}
              <Link
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-stone-500 text-[11px]">
          ...
          <span>Your personal information is confidential & protected</span>
        </div>
      </motion.div>
    </div>
  );
